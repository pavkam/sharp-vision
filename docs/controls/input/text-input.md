...
| `ReadOnly`, `AcceptsReturn`, `AcceptsTab`                      | `false`                | Control mutation, multiline Enter, and local Tab insertion.               |
...
- `ReadOnly`, `AcceptsReturn`, `AcceptsTab`, `PasswordCharacter`, and
