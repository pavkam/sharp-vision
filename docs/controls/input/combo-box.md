...
| Inherited `DropDownHeight`     | `Length`                                      | `Length.Cells(8)`                | Caps the ListView interior with an automatic, fixed-cell, or placement-relative maximum.                                 |
...
| Inherited `PopupChrome`        | `PopupChrome`                                 | `default`                        | Overrides the private Popup's border and shadow together (see [Popup](../popups/popup.md#overview)).                     |
| Inherited `ResetPopupChrome()` | `void`                                        | —                                | Returns the private Popup's border and shadow to `PopupChrome` ownership.                                                |
...
| Inherited `DropDownOpened`     | `EventHandler`                                | No subscribers                   | Raised after the drop-down list opens.                                                                                   |
| Inherited `DropDownClosed`     | `EventHandler`                                | No subscribers                   | Raised after the drop-down list closes.                                                                                  |
