...
| `AmbiguousWidth`              | `Ambiguous`              | Inherited cell policy | Read-only; always reflects the ambient cell policy's East Asian Ambiguous width - it cannot be overridden per instance.                       |
