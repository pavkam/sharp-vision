...
complete overflowing clusters. Grapheme and word ellipsis modes reserve one
narrow cell and never split a wide cluster. A cluster that cannot fit an empty
positive-width line is consumed as a clipped empty line rather than emitting a
half-wide glyph. Tabs advance to explicit four-cell stops.
