...
pointer leave, capture loss, disable, hide, detach, or disposal ends the drag.
...
Release, pointer leave, capture loss, disable, hide, detach, or disposal ends
the resize the same way as a drag. Only the bottom-right corner is an
