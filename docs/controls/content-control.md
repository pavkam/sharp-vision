...
ownership rejection leaving the tree untouched and dispatcher affinity enforced
even for equivalent assignments. Callback and property notifications arrive in
the documented order, callback failures never roll back the commit, and
direct-child and owner disposal publish the documented change. Collapsed
content, margin saturation, both-axis arrangement, rendering, hit testing, focus
navigation, and popup traversal are all covered by tests.
