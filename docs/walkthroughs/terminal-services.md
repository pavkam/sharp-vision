...
`Write` or `Request` that actually reached the terminal - success, terminal
failure, cancellation, or timeout - raises `KittyClipboardReplyReceived` once,
regardless of which protocol served it.
