...
options. `Loading` reports whether a directory enumeration is still outstanding,
and `Status` describes loading progress, entry counts, or a recoverable error
without exposing any private controls.
