...
| Display state                 | [DEC modes](dec-private-modes.md#overview), [SGR](sgr.md#overview), [synchronized output](synchronized-output.md#overview), and [grapheme clustering](grapheme-clustering.md#overview) | How rendering modes are acquired, used, and restored.               |
