...
| [ANSI and VT](ansi-vt.md#first-milestone-contract)                     | Decoded and observable: ECMA framing and a typed renderer subset exist; the compatibility profile remains phased. | VT100/220-compatible application behavior used by the renderer.         |
...
| [DCS and strings](dcs-strings.md#first-milestone-contract)             | Decoded and observable: bounded DCS, SOS, OSC, PM, and APC framing, cancellation, and recovery.                   | Bounded framing, recovery, and diagnostic observation.                  |
| [DEC modes](dec-private-modes.md#first-milestone-contract)             | Typed and implemented: modes 25, 1004, 1049, 2004, 2026, and 5522; lifecycle ownership is deferred.               | Application, cursor, screen, paste, focus, mouse, and restore modes.    |
...
| [Mouse](mouse.md#first-milestone-contract)                             | Unsupported with a specific reason: the typed cell/pixel pointer decoder is Phase 3 work.                         | X10, VT200, SGR cell, SGR pixel, wheel, motion, and modifiers.          |
| [Paste and focus](paste-focus.md#first-milestone-contract)             | Unsupported with a specific reason: typed paste and focus input events are Phase 3 work.                          | Bracketed paste and focus in/out events.                                |
| [Synchronized output](synchronized-output.md#first-milestone-contract) | Typed and implemented: mode 2026 set/reset/query bytes exist; guaranteed frame cleanup is deferred.               | DEC private mode 2026 with guaranteed cleanup.                          |
| [Device attributes](device-attributes.md#first-milestone-contract)     | Typed and implemented: DA1/DA2, CPR, DECRQM/DECRPM, color replies, bounded correlation, and timeouts.             | DA1/DA2, DECRQM/DECRPM, bounded timeouts, overrides.                    |
| [Kitty keyboard](kitty-keyboard.md#first-milestone-contract)           | Unsupported with a specific reason: the keyboard event decoder is Phase 3 work.                                   | Progressive enhancement and typed press/repeat/release events.          |
...
| [tmux](tmux.md#first-milestone-contract)                               | Unsupported with a specific reason: conservative narrowing exists, but safe passthrough wrapping does not.        | Safe DCS passthrough and capability override behavior.                  |
| [GNU screen](gnu-screen.md#first-milestone-contract)                   | Unsupported with a specific reason: conservative narrowing exists, but safe passthrough wrapping does not.        | Conservative feature filtering and DCS passthrough behavior.            |
