...
The sidebar remains one arrow-key `NavigationView`. Its heading, groups, and 53
...
sidebar organizes its 53 entries by primary use:
...
those automated contracts. Showcase tests enumerate the complete 53-page
