...
The sidebar remains one arrow-key `NavigationView`. Its heading, groups, and 54
...
sidebar organizes its 54 entries by primary use:
...
those automated contracts. Showcase tests enumerate the complete 54-page
