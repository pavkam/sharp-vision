...
description:
  Use when creating, updating, reviewing, or auditing SharpVision protocol,
  architecture, concept, control, testing, API, coverage-matrix, diagram,
  source-attribution, or section-link documentation.
---
...
Treat `docs/` as the normative product contract. Behavior is incomplete when the
specification, implementation, tests, XML docs, and showcase disagree.
