...
| List, Tree, Table, Tab, selection, semantic items, navigation                | [collections-and-navigation.md](references/collections-and-navigation.md) | [ItemsControl](../../../docs/controls/items-control.md#overview)                             |
...
| DateInput, TimeInput, DateTimeInput, temporal segments, Calendar popup       | [temporal-inputs.md](references/temporal-inputs.md)                       | [DateInput](../../../docs/controls/input/date-input.md#overview)                             |
