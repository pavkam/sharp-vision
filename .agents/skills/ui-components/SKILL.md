...
6. Update XML docs, normative contract, behavior catalog, and interactive
   showcase together; then run focused and repository gates.
...
| List, Tree, Tab, selection, semantic items, navigation                       | [collections-and-navigation.md](references/collections-and-navigation.md) | [ItemsControl](../../../docs/controls/items-control.md#itemscontrol-contract)                |
| Menu, Popup, Flyout, Tooltip, Window, Dialog, modal presentation             | [floating-surfaces.md](references/floating-surfaces.md)                   | [Floating surfaces](../../../docs/concepts/floating-surfaces.md#floating-surface-contract)   |
| TextInput, editing, selection, undo, clipboard, password, markup             | [text-editing.md](references/text-editing.md)                             | [TextInput](../../../docs/controls/input/text-input.md#textinput-contract)                   |
...
| Showcase page, DocPage, examples, navigation, visual capture                 | [showcase.md](references/showcase.md)                                     | [Showcase contract](../../../docs/architecture/showcase.md#showcase-contract)                |
