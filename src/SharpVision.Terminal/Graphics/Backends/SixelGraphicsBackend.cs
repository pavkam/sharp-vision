...
/// <summary>Configures the shared non-retained backend for RGBA sixel placement.</summary>
internal sealed class SixelGraphicsBackend: IGraphicsBackend
{
    private readonly NonRetainedGraphicsBackend _inner;

    /// <summary>Initializes bounded sixel output and an optional authorized tmux route.</summary>
