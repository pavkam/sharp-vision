...
internal static class BlockResolver
{
    ...
    public static Rune Resolve(Shade value, Ambiguous ambiguousWidth) => new(
    ...
    /// <param name="ambiguousWidth">The active frame width policy.</param>
    /// <returns>The exact Unicode Rune or a portable one-cell ASCII fallback.</returns>
    public static Rune Resolve(Quadrants value, Ambiguous ambiguousWidth) => new(
    ...
    public static bool TryDecode(Rune value, out Quadrants quadrants)
    {
