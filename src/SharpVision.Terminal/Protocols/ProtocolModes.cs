...
public static class ProtocolModes
{
    ...
    public static void Mouse(
        ...
        bool enabled)
    {
        ArgumentOutOfRangeException.ThrowIfNotDefined(tracking, nameof(tracking), "The mouse tracking mode is unknown.");

        ArgumentOutOfRangeException.ThrowIfNotDefined(coordinates, nameof(coordinates), "The mouse coordinate mode is unknown.");
