...
public sealed record TerminalCapabilities
{
    ...
    public ColorDepth ColorDepth
    {
        ...
        init
        {
            ArgumentOutOfRangeException.ThrowIfNotDefined(value, nameof(value), "The color depth is unknown.");
    ...
    public Origin ColorOrigin
    {
        ...
        init
        {
            ArgumentOutOfRangeException.ThrowIfNotDefined(value, nameof(value), "The color-depth evidence origin is unknown.");
    ...
    public Ambiguous AmbiguousWidth
    {
        ...
        init
        {
            ArgumentOutOfRangeException.ThrowIfNotDefined(value, nameof(value), "The ambiguous-width policy is unknown.");
