...
public sealed class Description
{
        ...
        bool eatNewlineGlitch = false)
    {
        ...
        ArgumentOutOfRangeException.ThrowIfNotDefined(origin, nameof(origin), "The description origin is unknown.");

        ArgumentOutOfRangeException.ThrowIfNotDefined(suitability, nameof(suitability), "The suitability result is unknown.");
