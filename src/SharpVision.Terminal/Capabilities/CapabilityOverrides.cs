...
public sealed record CapabilityOverrides
{
    ...
    public ColorDepth? ColorDepth
    {
        ...
        init
        {
            if (value.HasValue)
            {
                ArgumentOutOfRangeException.ThrowIfNotDefined(value.Value, nameof(value), "The color depth is unknown.");
            }
    ...
    public Ambiguous? AmbiguousWidth
    {
        ...
        init
        {
            if (value.HasValue)
            {
                ArgumentOutOfRangeException.ThrowIfNotDefined(value.Value, nameof(value), "The ambiguous-width policy is unknown.");
            }
