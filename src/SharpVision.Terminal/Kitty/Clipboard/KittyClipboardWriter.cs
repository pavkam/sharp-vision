...
public static class KittyClipboardWriter
{
    ...
    /// <param name="writer">The validated protocol writer.</param>
    public static void WriteEnd(ProtocolWriter writer) => writer.Osc(5522, "type=wdata"u8);

    /// <summary>Queries support using standard DECRQM mode 5522.</summary>
    /// <param name="writer">The validated protocol writer.</param>
    public static void QuerySupport(ProtocolWriter writer) => Csi.QueryPrivateMode(writer, 5522);
