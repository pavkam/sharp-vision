...
internal static partial class Native
{
    ...
    private const nuint _macGetSize = 0x40087468;
    ...
    internal static Dimensions GetDimensions(int fileDescriptor)
    {
        ...
        if (Ioctl(fileDescriptor, request, ref value) != 0)
        {
    ...
    private static partial int Ioctl(int fileDescriptor, nuint request, ref WindowSize value);
