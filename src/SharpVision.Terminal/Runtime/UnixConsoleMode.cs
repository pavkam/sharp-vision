...
internal sealed class UnixConsoleMode: IDisposable
{
    ...
    private UnixConsoleMode(byte[]? restore, int fileDescriptor, Func<int, byte[], bool> restoreAttributes)
    {
        ...
        Func<int, byte[], bool>? restoreAttributes = null)
    {
        ...
        {
            return new UnixConsoleMode(restore: null, fileDescriptor, restoreWrite);
        }
        ...
        return new UnixConsoleMode(restore, fileDescriptor, restoreWrite);
    }
