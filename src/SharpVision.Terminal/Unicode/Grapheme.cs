...
/// <summary>
/// Identifies one extended grapheme cluster inside a borrowed UTF-16 span.
/// </summary>
...
/// <summary>
/// Provides an allocation-free enumerable over borrowed UTF-16 text.
/// </summary>
public readonly ref struct GraphemeEnumerable
{
    ...
    /// <summary>
    /// Initializes an enumerable over a span borrowed for the enumeration.
    /// </summary>
...
/// <summary>
/// Segments borrowed UTF-16 text using Unicode 17 extended-grapheme rules.
/// </summary>
public ref struct GraphemeEnumerator
{
    ...
    /// <summary>
    /// Initializes an enumerator positioned before the first cluster.
    /// </summary>
    /// <param name="value">The borrowed UTF-16 text.</param>
...
/// <summary>
/// Creates allocation-free Unicode 17 extended-grapheme enumerators.
/// </summary>
