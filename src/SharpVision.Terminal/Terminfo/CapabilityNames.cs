...
/// degrade a feature, so a typo in one consumption site cannot drift from the others.
/// </summary>
/// <remarks>
...
/// independently re-type today, starting with the pairs <see cref="Programs.FullScreenReady"/>
