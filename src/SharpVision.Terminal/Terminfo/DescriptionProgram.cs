...
internal readonly struct DescriptionProgram
{
    ...
    private DescriptionProgram(bool builtin)
    {
        Debug.Assert(builtin, "The private constructor creates only intrinsic programs.");
    ...
    /// </summary>
    public static DescriptionProgram Intrinsic { get; } = new(builtin: true);
    ...
    public bool IsEmpty => !Builtin && (_representation is null || _representation.Length == 0);
    ...
    public bool Compiled => _operations is { Length: > 0 };
