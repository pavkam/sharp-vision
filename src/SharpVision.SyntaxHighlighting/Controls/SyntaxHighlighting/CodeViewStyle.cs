...
public sealed record CodeViewStyle: ContainerStyle
{
    ...
    private static CodeViewStyle Complete(ContainerStyle container, VisualState state) =>
        new(
            container.Face,
            container.Border,
            container.Shadow,
            normalColor: SemanticColor.ControlText,
            keywordColor: SemanticColor.Accent,
            functionColor: SemanticColor.Info,
            variableColor: SemanticColor.ControlText,
            controlFlowColor: SemanticColor.Accent,
            operatorColor: SemanticColor.ControlText,
            builtInColor: SemanticColor.Info,
            extensionColor: SemanticColor.Info,
            preprocessorColor: SemanticColor.Warning,
            attributeColor: SemanticColor.Info,
            charColor: SemanticColor.Success,
            specialCharColor: SemanticColor.Success,
            stringColor: SemanticColor.Success,
            verbatimStringColor: SemanticColor.Success,
            specialStringColor: SemanticColor.Success,
            importColor: SemanticColor.Accent,
            dataTypeColor: SemanticColor.Info,
            decimalValueColor: SemanticColor.Warning,
            baseNColor: SemanticColor.Warning,
            floatColor: SemanticColor.Warning,
            constantColor: SemanticColor.Warning,
            commentColor: SemanticColor.Muted,
            documentationColor: SemanticColor.Muted,
            annotationColor: SemanticColor.Info,
    ...
    public static new CodeViewStyle Default => Complete(ContainerStyle.Default, VisualState.Normal);
