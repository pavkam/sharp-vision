    ...
    ISelectableTextViewport
{
    ...
    /// <inheritdoc/>
    protected override TextSelectionMap GetTextSelectionMap() => EnsureSelectionProjection();
        ...
        while (true)
        {
            ...
            if (candidates[index].Item is DocumentLink link)
            {
                ...
                ActiveLink = link;
                     ...
                     !FocusDescendant(control, FocusReason.Keyboard, cancellable: true))
            {
                continue;
            }
    ...
    /// <inheritdoc/>
    protected override TextSelectionSource? GetTextSelectionSource(ControlBase? originalSource, Point cells)
    {
        var map = EnsureSelectionProjection();
