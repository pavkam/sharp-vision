...
public readonly record struct ThemeAppearance
{
    ...
    public ThemeAppearance(Face face, Border border, Shadow shadow)
    {
        Face = face;
        Border = border;
        Shadow = shadow;
    ...
    public ThemeAppearance Apply(AppearanceSet set) => new(
