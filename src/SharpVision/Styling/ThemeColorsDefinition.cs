...
/// <summary>Defines concrete values for every fixed semantic color role.</summary>
[JsonUnmappedMemberHandling(JsonUnmappedMemberHandling.Disallow)]
internal sealed class ThemeColorsDefinition
{
    ...
    internal string? Get(ThemeColor role) => role switch
    {
        ThemeColor.Window => Window,
        ThemeColor.WindowText => WindowText,
        ThemeColor.Surface => Surface,
        ThemeColor.SurfaceText => SurfaceText,
        ThemeColor.Control => Control,
        ThemeColor.ControlText => ControlText,
        ThemeColor.ControlBorder => ControlBorder,
        ThemeColor.ControlShadow => ControlShadow,
        ThemeColor.ActiveControl => ActiveControl,
        ThemeColor.ActiveText => ActiveText,
        ThemeColor.ActiveBorder => ActiveBorder,
        ThemeColor.FocusedControl => FocusedControl,
        ThemeColor.FocusedText => FocusedText,
        ThemeColor.FocusedBorder => FocusedBorder,
        ThemeColor.PressedControl => PressedControl,
        ThemeColor.PressedText => PressedText,
        ThemeColor.PressedBorder => PressedBorder,
        ThemeColor.SelectedControl => SelectedControl,
        ThemeColor.SelectedText => SelectedText,
        ThemeColor.DisabledControl => DisabledControl,
        ThemeColor.DisabledText => DisabledText,
        ThemeColor.DisabledBorder => DisabledBorder,
        ThemeColor.Accent => Accent,
        ThemeColor.Muted => Muted,
        ThemeColor.Hotkey => Hotkey,
        ThemeColor.Error => Error,
        ThemeColor.Warning => Warning,
        ThemeColor.Success => Success,
        ThemeColor.Info => Info,
        _ => throw new ArgumentOutOfRangeException(nameof(role), role, "The theme color role is unknown.")
    };
}
