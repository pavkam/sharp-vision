...
public readonly record struct SeparatorGlyphs
{
    ...
    /// <param name="tablePlaceholder">The table progressive-loading placeholder glyph.</param>
    /// <param name="tablePlaceholderError">The table progressive load-failure placeholder glyph.</param>
    ...
    public SeparatorGlyphs(
        ...
        ControlGlyph tablePlaceholder,
        ControlGlyph tablePlaceholderError,
        ...
        ControlGlyph tabUnderline)
    {
        ...
        TablePlaceholderError = tablePlaceholderError;
    ...
    /// <summary>Gets the table progressive-loading placeholder glyph.</summary>
    public ControlGlyph TablePlaceholder { get; }

    /// <summary>Gets the table progressive load-failure placeholder glyph.</summary>
    public ControlGlyph TablePlaceholderError { get; }
