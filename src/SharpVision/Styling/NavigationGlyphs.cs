...
public readonly record struct NavigationGlyphs
{
    ...
    public NavigationGlyphs(
        ThemedGlyph itemIdle,
        ThemedGlyph itemCurrent,
        ThemedGlyph groupCollapsed,
        ThemedGlyph groupExpanded,
        ThemedGlyph separator)
    {
        ItemIdle = itemIdle;
