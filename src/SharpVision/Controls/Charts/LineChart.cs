...
public sealed class LineChart: ChartControlBase
{
    ...
    public ChartLegendPlacement LegendPlacement { get => State.LegendPlacement; set => State.LegendPlacement = value; }

    /// <summary>Gets or sets whether category labels consume plot cells when they fit.</summary>
    public bool ShowCategoryLabels { get => State.ShowCategoryLabels; set => State.ShowCategoryLabels = value; }

    /// <summary>Gets or sets whether numeric point values are drawn when they fit.</summary>
    public bool ShowValueLabels { get => State.ShowValueLabels; set => State.ShowValueLabels = value; }
