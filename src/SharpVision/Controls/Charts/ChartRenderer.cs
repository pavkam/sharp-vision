...
internal static class ChartRenderer
{
        ...
        TerminalStyle inheritedStyle)
    {
        ...
        var range = ChartScaleResolver.Resolve(chart.Scale, chart.Series);
    ...
    /// <summary>Renders one series' point-marker glyphs and their optional value labels.</summary>
    internal static void RenderPointMarkers(
        ChartRenderContext context,
        TerminalCanvas canvas,
        Rect plot,
        ChartSeries series,
