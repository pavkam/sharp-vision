...
[PublicAPI]
public sealed class StatusBarItem: ContentControl, IStyled<StatusBarItemStyle>
{
    ...
    public StatusBarItemAlignment Alignment
    {
        ...
        set
        {
            ArgumentOutOfRangeException.ThrowIfNotDefined(value, nameof(value), "The status-bar alignment is unknown.");
