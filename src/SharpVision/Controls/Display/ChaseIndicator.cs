...
public sealed class ChaseIndicator: Control<ChaseIndicatorStyle>
{
    ...
    {
        _animation = new AnimationTimer(TimeSpan.FromMilliseconds(200), OnTick, () => EffectiveIsVisible) { Playing = true };
    ...
    public bool Playing
    {
        ...
        set
        {
            ...
            _animation.Playing = value;
            field = value;
            NotifyPropertyChanged(nameof(Playing), InvalidationImpact.None);
        }
    } = true;
