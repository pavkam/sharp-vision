...
/// <c>src/SharpVision.Terminal/EnumValidation.cs</c>, because that assembly cannot reference this
/// type regardless of its accessibility: the project dependency points the other way, from
