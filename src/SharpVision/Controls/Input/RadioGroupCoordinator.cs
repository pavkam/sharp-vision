    ...
    extension(RadioButton value)
    {
        ...
        public bool MoveGroup(bool reverse)
        {
            ...
            var eligible = members.FindAll(static member =>
                member is { Disposed: false, EffectiveIsEnabled: true, EffectiveIsVisible: true, CanFocus: true });
        ...
        public bool IsRovingTabStop()
        {
            ...
            var eligible = Members(value).Where(static member =>
                member is
                {
                    Disposed: false, EffectiveIsEnabled: true, EffectiveIsVisible: true, TabStop: true, CanFocus: true
                }).ToList();
