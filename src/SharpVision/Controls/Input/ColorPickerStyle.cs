...
/// <see cref="SliderStyle"/>/<see cref="StatusFace"/>.</summary>
[PublicAPI]
public sealed record ColorPickerStyle: ControlStyle
{
    ...
    [SetsRequiredMembers]
    public ColorPickerStyle(Face face, Border border, Shadow shadow, SliderStyle? sliderStyle, Face? statusFace) : base(face, border, shadow)
    {
