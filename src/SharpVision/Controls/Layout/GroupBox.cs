...
public sealed class GroupBox: HeaderedContentControl
{
    ...
    // Widened here rather than on HeaderedContentControl, for the same reason
    // ChromeAuthoringContainer exists instead of widening Container: the other headered types are
    ...
    // framed control whose entire purpose is a caller-authored titled border. There is no
    // ChromeAuthoring* base for this branch because it would have exactly one member.
