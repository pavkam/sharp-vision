...
internal interface IFilePickerFileSystem
{
    ...
    /// <summary>Determines whether one canonical path refers to an existing directory.</summary>
    /// <param name="path">The non-null path to test.</param>
    /// <returns><see langword="true"/> when the path identifies an existing directory; otherwise, false.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="path"/> is null.</exception>
