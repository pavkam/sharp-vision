...
public sealed class NavigationViewGroup: ControlBase
{
    ...
    protected override Size MeasureOverride(Constraint constraint)
    {
        ...
        var childrenHeight = Expanded ? childrenDesired.Height : 0;
    ...
    protected override void ArrangeOverride(Rect bounds)
    {
        ...
        var slot = Expanded && bounds.Height > 1
    ...
    protected override void OnRenderContent(TerminalCanvas canvas)
    {
        ...
        var glyph = (Expanded ? ActualStyle.ExpandedGlyph : ActualStyle.CollapsedGlyph).Resolve(themed.Fallback, CellPolicy.AmbiguousWidth);
