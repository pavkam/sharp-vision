...
internal readonly record struct NavigationItemPresentation
{
    ...
    public NavigationItemPresentation(bool focusable, bool tabStop, long version)
    {
    ...
    public NavigationItemPresentation WithFocusable(bool value) => new(value, IsTabStop, Version);
    ...
    /// <returns>The updated immutable snapshot.</returns>
    public NavigationItemPresentation WithTabStop(bool value) => new(IsFocusable, value, Version);
}
