    ...
    IAsyncDisposable
{
        ...
        TimeProvider? timeProvider = null)
    {
        ...
        ObjectDisposedException.ThrowIf(root.Disposed, root);
    ...
    /// </remarks>
    internal TimeSpan ClipboardQueryTimeout =>
        (_options.Negotiation?.Limits ?? QueryLimits.Default).QueryTimeout;
            ...
            case RecordKind.Key:
                {
                    ...
                    // setting Handled, a preview-phase clipboard shortcut, or (below) an
