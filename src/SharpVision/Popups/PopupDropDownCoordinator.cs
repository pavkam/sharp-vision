...
internal sealed class PopupDropDownCoordinator
{
    ...
    private readonly Action _raiseOpenedPropertyChanged;
    ...
    /// <param name="raiseOpenedPropertyChanged">Publishes the owner's Opened PropertyChanged notification.</param>
    ...
    public PopupDropDownCoordinator(
        ...
        Action raiseOpenedPropertyChanged,
        ...
        Action? beforeCloseFocusRestore = null)
    {
        ...
        ArgumentNullException.ThrowIfNull(raiseOpenedPropertyChanged);
        ...
        _raiseOpenedPropertyChanged = raiseOpenedPropertyChanged;
