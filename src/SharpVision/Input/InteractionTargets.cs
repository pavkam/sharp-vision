...
internal readonly struct InteractionTargets
{
    ...
    /// <param name="deliveryBoundary">The inclusive boundary used to resolve delivery-target focus eligibility, or null.</param>
    ...
    /// <summary>Gets the inclusive boundary used to resolve delivery-target focus eligibility, or null.</summary>
    public ControlBase? DeliveryBoundary { get; }
