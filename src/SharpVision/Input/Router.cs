...
public static class Router
{
        ...
        Action<TArgs>? initialize) where TArgs : RoutedEventArgs
    {
        ...
        try
        {
            ...
            // Ancestry traversal is never cut short. IsHandled suppresses ordinary handlers and
            ...
            result = new RouteResult(eventArgs.IsHandled, eventArgs.PostRouteCommand, eventArgs.OriginalSource);
        }
        finally
        {
            if (began)
