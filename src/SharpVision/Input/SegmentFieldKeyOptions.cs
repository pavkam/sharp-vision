...
internal sealed class SegmentFieldKeyOptions
{
    ...
    /// <param name="handleRecognizedWithoutChange">Whether an admitted inline command is handled even when it cannot change the value or active segment. Default is true so field-boundary navigation and already-clamped edits do not leak to ancestor shortcuts.</param>
    ...
    public SegmentFieldKeyOptions(
        ...
        bool handleRecognizedWithoutChange = true)
    {
