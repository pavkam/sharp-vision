...
public static class Layout
{
        ...
        Span<Line> destination)
    {
        ...
        ArgumentOutOfRangeException.ThrowIfNotDefined(overflow, nameof(overflow), "The enum value is unknown.");
        ArgumentOutOfRangeException.ThrowIfNotDefined(alignment, nameof(alignment), "The enum value is unknown.");
        ArgumentOutOfRangeException.ThrowIfNotDefined(ambiguous, nameof(ambiguous), "The enum value is unknown.");
        var count = 0;
        var start = 0;
