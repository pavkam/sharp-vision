...
internal readonly struct TextSelectionGlyph
{
    ...
    internal TextSelectionGlyph(Selection range, Rect bounds, TextSelectionSource? source = null)
    {
    ...
    internal TextSelectionSource? Source { get; }
}
