...
internal sealed class ComponentScreen: ISequenceSink
{
    ...
    internal ComponentScreen(Size size)
    {
        ...
        for (var index = 0; index < values.Length; index++)
        {
            ...
            switch (value)
            {
                ...
                case 9:
                    ...
                    break;
                case 22:
                    _attributes &= ~(Attributes.Bold | Attributes.Dim);
                    break;
                case 23:
                    _attributes &= ~Attributes.Italic;
                    break;
                ...
                case 29:
                    ...
                    break;
                case >= 30 and <= 37:
                    _foreground = Color.Indexed(value - 30);
                    break;
                case 38:
                ...
                case 39:
                    ...
                    break;
                case >= 40 and <= 47:
                    _background = Color.Indexed(value - 40);
                    break;
                case 48:
                ...
                case 59:
                    ...
                    break;
                case >= 90 and <= 97:
                    _foreground = Color.Indexed(value - 90 + 8);
                    break;
                case >= 100 and <= 107:
                    _background = Color.Indexed(value - 100 + 8);
                    break;
                default:
                    break;
            }
    ...
    private void Repair(int x, int y)
    {
        ...
        {
            _cells[IndexUnchecked(new Point(leadX + offset, y))] = SurfaceCell.Blank with
            {
                Style = lead.Style,
            };
        }
    ...
    private static Color ParseColor(string[] values, ref int index)
    {
        ...
        return mode == 5
            ? Color.Indexed(ParseNumber(values[++index]))
            : mode == 2
                ? Color.Rgb(
