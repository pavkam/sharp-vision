...
internal sealed class ProbeControl: ChromeProbe
{
    ...
    /// <summary>Gets the number of render-clean reuse invocations.</summary>
    ...
    /// tracking, exercising the protected PressedState seam.</summary>
    internal bool ForcedPressedState { get; set; }

    /// <inheritdoc/>
    protected override bool PressedState => ForcedPressedState || base.PressedState;
    ...
    /// <inheritdoc/>
    /// <remarks>
    /// Proves the render-clean reuse wiring itself: this fires exactly when the render
    ...
    protected override void OnLostPointerCapture(PointerCaptureLossReason reason)
    {
        ...
        PointerStateWasClearDuringCancellation =
            !HasPointerCapture && !PointerOver && !Pressed;
