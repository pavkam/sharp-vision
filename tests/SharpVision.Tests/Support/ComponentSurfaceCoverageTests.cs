...
public sealed class ComponentSurfaceCoverageTests
{
    ...
    /// <summary>Gets the catalogued mounted behavior requirement for every public concrete control.</summary>
    /// <remarks>Exposed so the detached unit coverage gate reads the same source of truth instead of
    /// duplicating the disabled-evidence classification.</remarks>
    internal static IReadOnlyDictionary<Type, ComponentBehaviorRequirement> Requirements => _requirements;
    ...
    // catalog mistake fails the moment this type initializes.
    private static readonly Dictionary<Type, ComponentBehaviorRequirement> _requirements = new()
    {
        { typeof(ControlText), Requirement<TextSurfaceTests>(_passive | ComponentBehavior.Hover) },
        { typeof(HorizontalBarChart), Requirement<ChartSurfaceTests>(_passive | ComponentBehavior.HoverExcluded) },
        { typeof(VerticalBarChart), Requirement<ChartSurfaceTests>(_passive | ComponentBehavior.HoverExcluded) },
        { typeof(LineChart), Requirement<ChartSurfaceTests>(_passive | ComponentBehavior.HoverExcluded) },
        { typeof(AreaChart), Requirement<ChartSurfaceTests>(_passive | ComponentBehavior.HoverExcluded) },
        { typeof(Sparkline), Requirement<ChartSurfaceTests>(_passive | ComponentBehavior.HoverExcluded) },
        ...
        { typeof(TimeInput), Requirement<TimeInputSurfaceTests>(
            ...
            ComponentBehavior.DirectionalExcluded |
            ComponentBehavior.PressReleaseExcluded) },
        { typeof(NumberInput), Requirement<NumberInputSurfaceTests>(
            _interactive |
            ComponentBehavior.DirectionalExcluded |
            ComponentBehavior.PressReleaseExcluded) },
        { typeof(CurrencyInput), Requirement<CurrencyInputSurfaceTests>(
            _interactive |
            ComponentBehavior.DirectionalExcluded |
            ComponentBehavior.PressReleaseExcluded) },
        { typeof(ColorPicker), Requirement<ColorPickerSurfaceTests>(
            ...
            ComponentBehavior.UnavailableCleanup |
            ComponentBehavior.Composition) },
        { typeof(UiListView), Requirement<ListViewSurfaceTests>(
            _interactive |
            ComponentBehavior.Directional |
            ComponentBehavior.PressReleaseExcluded |
            ComponentBehavior.Activation |
        ...
        { typeof(JsonView), Requirement<JsonViewSurfaceTests>(
            _interactive |
            ComponentBehavior.Directional |
            ComponentBehavior.PressReleaseExcluded |
            ComponentBehavior.Activation |
    ...
    public void Catalog_WhenPublicConcreteControlsChange_RequiresExplicitBehaviorClassification()
    {
        ...
        _requirements.Values.ShouldAllBe(requirement =>
            ...
            HasExactlyOne(
                requirement.Behaviors,
                ComponentBehavior.Disabled,
                ComponentBehavior.DisabledExcluded));
    }
