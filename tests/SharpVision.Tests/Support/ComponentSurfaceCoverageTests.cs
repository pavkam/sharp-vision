...
public sealed class ComponentSurfaceCoverageTests
{
    ...
    private static readonly Dictionary<Type, ComponentBehaviorRequirement> _requirements = new()
    {
        ...
        [typeof(Grid)] = Requirement<GridSurfaceTests>(_passive | ComponentBehavior.Hover | ComponentBehavior.Composition),
        [typeof(Overlay)] = Requirement<OverlaySurfaceTests>(_passive | ComponentBehavior.Hover | ComponentBehavior.Composition),
        [typeof(Stack)] = Requirement<StackSurfaceTests>(_passive | ComponentBehavior.Hover | ComponentBehavior.Composition),
        [typeof(GroupBox)] = Requirement<GroupBoxSurfaceTests>(_passive | ComponentBehavior.Hover | ComponentBehavior.Composition),
        ...
        [typeof(List)] = Requirement<ListSurfaceTests>(
            ...
            ComponentBehavior.UnavailableCleanup |
            ComponentBehavior.Composition),
        [typeof(Table)] = Requirement<TableSurfaceTests>(_passive | ComponentBehavior.Hover | ComponentBehavior.Composition),
        [typeof(TabControl)] = Requirement<TabBehaviorSurfaceTests>(
            ...
            ComponentBehavior.UnavailableCleanup |
            ComponentBehavior.Composition),
        [typeof(TabItem)] = Requirement<TabBehaviorSurfaceTests>(_passive | ComponentBehavior.Hover | ComponentBehavior.Composition),
