...
public sealed class AppearanceStatesTests
{
    ...
    {
        // OrderedOverlays processes IsPointerOver, then Focused, then Checked. Folding one overlay
        // at a time and validating on every step would reject the IsPointerOver+Focused
        ...
        var resolved = Should.NotThrow(() =>
            profile.Resolve(VisualState.IsPointerOver | VisualState.Focused | VisualState.Checked));
