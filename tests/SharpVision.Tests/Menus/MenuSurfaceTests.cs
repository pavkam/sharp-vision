...
public sealed class MenuSurfaceTests
{
    ...
    public async Task Input_WhenMenuNavigatesAndInvokes_UsesOwnedFacesWithoutFocusTheftAsync()
    {
        ...
        second.Pressed.ShouldBeTrue();
        second.Focused.ShouldBeFalse();
        menu.Pressed.ShouldBeFalse();
        ...
        await surface.Pointer.PressAsync();
        await surface.UpdateAsync(() => second.Enabled = false, "disable held MenuItem");
        await surface.UpdateAsync(() => menu.Enabled = false, "disable focused Menu");

        // Assert cleanup
        second.Pressed.ShouldBeFalse();
        menu.Focused.ShouldBeFalse();
    ...
    public async Task PointerAndEscape_WhenMenuChainIsOpen_SwitchesSiblingAndRestoresOwnerFocusAsync()
    {
        ...
        close.PointerOver.ShouldBeTrue();
