...
public sealed class LightDismissTests
{
    ...
    public async Task Pointer_WhenMenuIsOpenedInsideAModalDialog_ClosesOnOutsidePressAsync()
    {
        ...
        menu.IsOpen.ShouldBeFalse("an outside press inside the modal plane must dismiss the menu");
    ...
    public async Task Pointer_WhenPressLandsOnTheMenuInsideAModalDialog_LeavesItOpenAsync()
    {
        ...
        menu.IsOpen.ShouldBeTrue("a press on the menu itself must not dismiss it");
