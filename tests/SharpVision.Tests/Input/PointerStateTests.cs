...
public sealed class PointerStateTests
{
    ...
    public async Task Dispatch_WhenPointerHitsChild_SetsDirectAndAncestorPointerStateAsync()
    {
        ...
        await dispatcher.InvokeAsync(() =>
        {
            ...
            _ = capture.Dispatch(new Pointer(new Point(3, 3), null, Buttons.None, PointerAction.Move, 0, 0, Modifiers.None, true, false));
    ...
    public async Task Dispatch_WhenPointerMovesBetweenSiblings_PreservesSharedAncestorPointerStateAsync()
    {
        ...
        await dispatcher.InvokeAsync(() =>
        {
            ...
            _ = pointer.Dispatch(new Pointer(new Point(1, 1), null, Buttons.None, PointerAction.Move, 0, 0, Modifiers.None, true, false));
            _ = pointer.Dispatch(new Pointer(new Point(7, 1), null, Buttons.None, PointerAction.Move, 0, 0, Modifiers.None, true, false));
