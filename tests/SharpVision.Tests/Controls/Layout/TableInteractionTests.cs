...
public sealed class TableInteractionTests
{
    ...
    /// plus their one-cell inter-column gap settle at a 25-cell extent instead of shrinking or
    /// inflating around a stale width.</summary>
    [Fact]
    public async Task Layout_WhenHorizontallyScrollingTableHasPercentColumn_ResolvesAgainstViewportNotExtentAsync()
    {
        ...
        table.Extent.Width.ShouldBe(25);
    }
