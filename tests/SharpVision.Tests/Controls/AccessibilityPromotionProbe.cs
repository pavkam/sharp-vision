...
/// for component authors by #155 (ResolveColor, MaximumImpact).</summary>
internal sealed class AccessibilityPromotionProbe: ControlBase
{
    ...
    internal static Color ProbeResolveColor(ColorValue value, Theme? theme) => ResolveColor(value, theme);
