...
public sealed class OwnedControlRegistryTests
{
    ...
    public async Task Attach_WhenProspectiveAppearanceThrows_PreservesContextAsync()
    {
        ...
        var theme = new Theme();
        theme.Freeze();
        var control = new StyledProbe { AppearanceProfileFailureTheme = theme };
        ...
        control.AppearanceProfileFailureTheme = null;
    ...
    public void Replace_WhenProspectiveAppearanceThrows_PreservesBothOwnershipTrees()
    {
        ...
        var replacement = new StyledProbe { AppearanceProfileFailureTheme = theme };
        ...
        replacement.AppearanceProfileFailureTheme = null;
        owner.PrimaryCount.ShouldBe(1);
