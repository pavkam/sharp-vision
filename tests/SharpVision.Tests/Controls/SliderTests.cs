...
public sealed class SliderTests
{
    ...
    public void Properties_WhenAssignmentIsInvalid_PreservePreviousState()
    {
        ...
        _ = Should.Throw<ArgumentException>(() => slider.Minimum = 6);
        _ = Should.Throw<ArgumentException>(() => slider.Maximum = 4);
