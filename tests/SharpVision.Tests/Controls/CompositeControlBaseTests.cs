...
public sealed class CompositeControlBaseTests
{
    ...
    /// <summary>Verifies a hidden composition root retains its slot and margin contribution to the
    /// owner's desired size while still excluding rendering and hit-testing - the shared base
    ...
    {
        var root = new ProbeControl(new Size(1, 1))
        {
