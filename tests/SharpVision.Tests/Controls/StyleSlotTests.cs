...
public sealed class StyleSlotTests
{
    ...
    public void Style_WhenGenericControlAssignsAndResets_UsesFrameworkFacade()
    {
        ...
        control.ActualStyle.ShouldBe(new ButtonStyle(ButtonStyle.Standard.Padding, Themes.Dark.Input));
    ...
    public void Local_WhenAssignedAndReset_ResolvesLocalThenTheme()
    {
        ...
        var local = new ButtonStyle(new Thickness(3), Themes.Load("default-light").Input);
        ...
        // Assert
        assigned.ShouldBe(local);
        reset.ShouldBe(new ButtonStyle(ButtonStyle.Standard.Padding, Themes.Dark.Input));
    }
    ...
    public void BindStyle_WhenLocalIsAssignedAndReset_ForwardsNullableLocal()
    {
        ...
        control.Target.ActualStyle.ShouldBe(new ButtonStyle(ButtonStyle.Standard.Padding, Themes.Dark.Input));
    }
    ...
    public void Local_WhenSlotHasUpstreamOwner_Throws()
    {
        ...
        var exception = Should.Throw<InvalidOperationException>(() =>
            control.Target.Style = new ButtonStyle(new Thickness(3), Themes.Dark.Input));
