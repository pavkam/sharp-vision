...
namespace SharpVision.Tests.Controls.SyntaxHighlighting;
...
public sealed class CodeViewSurfaceTests
{
    ...
    [Fact]
    [ComponentUnitEvidence(typeof(CodeView), ComponentBehavior.Mounted)]
    ...
    [Fact]
    [ComponentUnitEvidence(typeof(CodeView), ComponentBehavior.Mounted | ComponentBehavior.Focus)]
    ...
    [Fact]
    [ComponentUnitEvidence(typeof(CodeView), ComponentBehavior.Mounted | ComponentBehavior.Directional)]
