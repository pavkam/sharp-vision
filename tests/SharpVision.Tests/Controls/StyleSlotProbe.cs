...
public sealed class StyleSlotProbe: ControlBase
{
    ...
    private ButtonStyle Complete(ThemeProfile profile)
    {
        CompletionCalls++;
        return new ButtonStyle(ButtonStyle.Standard.Padding, profile);
    }
}
