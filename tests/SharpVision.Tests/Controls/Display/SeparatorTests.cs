...
public sealed class SeparatorTests
{
    ...
    public void Glyphs_WhenCustomized_OverrideDefaultsAndResetRestores()
    {
        // Arrange
        var separator = new Separator();
        var defaultHorizontal = separator.HorizontalGlyph;
        var defaultVertical = separator.VerticalGlyph;

        // Act
        separator.HorizontalGlyph = new Rune('=');
        separator.VerticalGlyph = new Rune('|');
        ...
        // Assert restored
        separator.HorizontalGlyph.ShouldBe(defaultHorizontal);
        separator.VerticalGlyph.ShouldBe(defaultVertical);
    }
    ...
    public void Constructor_WhenCreated_UsesBorderForeground()
    {
        ...
        // Assert
        separator.Face.Foreground.ShouldBe(ThemeColor.ControlText);
    }
