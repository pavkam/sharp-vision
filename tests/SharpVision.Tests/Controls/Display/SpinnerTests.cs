...
public sealed class SpinnerTests
{
    ...
    public void Style_WhenThemeAndLocalValuesChange_UsesDocumentedPrecedence()
    {
        ...
        spinner.ActualStyle.ShouldBe(SpinnerStyle.Definition.Resolve(null, theme));
    ...
    public void Constructor_WhenCreated_UsesDocumentedDefaults()
    {
        ...
        // Assert
        spinner.Style.ShouldBeNull();
        spinner.ActualStyle.ShouldBe(SpinnerStyle.Definition.Resolve(null, ThemeCatalog.Dark));
        spinner.Interval.ShouldBe(TimeSpan.FromMilliseconds(200));
        spinner.Playing.ShouldBeTrue();
        ...
        spinner.HitTestVisible.ShouldBeFalse();
    }
    ...
    /// <summary>Verifies setting the same Playing value does not trigger notification.</summary>
    [Fact]
