...
public sealed class ProgressBarStyleSetTests
{
    ...
    {
        var baseline = ProgressBarStyle.Default;
        var set = new ProgressBarStyleSet(fillColor: Color.Rgb(255, 0, 0));
    ...
    {
        var baseline = ProgressBarStyle.Default;
        var set = new ProgressBarStyleSet(
    ...
    public void StyleSet_WhenPartColorIsTransparent_ThrowsAtConstruction(int part)
    {
        ...
        var exception = Should.Throw<ArgumentException>(() => new ProgressBarStyleSet(
