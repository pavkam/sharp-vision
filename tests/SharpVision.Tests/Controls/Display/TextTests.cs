...
public sealed class TextTests
{
    ...
    public void Constructor_WhenCreated_UsesDocumentedDefaults()
    {
        ...
        value.Face.Foreground.ShouldBe(ThemeColor.ControlText);
        value.Face.Background.ShouldBe(ThemeColor.Control);
        value.Face.Attributes.ShouldBe(ThemeDecoration.NormalText);
    ...
    public void Setters_WhenValuesAreInvalid_ThrowBeforeMutation()
    {
        ...
        text.Face.Attributes.ShouldBe(ThemeDecoration.NormalText);
    }
