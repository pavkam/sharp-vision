...
public readonly record struct SurfaceCell
{
    ...
    /// </exception>
    public SurfaceCell(string text, TerminalStyle style, int width, bool isContinuation, int leadX)
    {
    ...
    public static SurfaceCell Blank { get; } = new(" ", TerminalStyle.Default, 1, false, 0);
    ...
    public TerminalStyle Style { get; init; }
