...
/// <remarks>
/// SharpVision.Terminal.Tests keeps a mirrored copy of this class at
/// <c>tests/SharpVision.Terminal.Tests/Support/ReferenceColors.cs</c>, byte-identical apart from its
/// namespace, because layering this project's own dependency on core <c>SharpVision</c> onto the
...
public static class ReferenceColors
{
    ...
    public static Color Get(int position)
    {
