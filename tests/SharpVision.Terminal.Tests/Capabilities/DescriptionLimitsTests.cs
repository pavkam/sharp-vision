...
public sealed class DescriptionLimitsTests
{
    ...
    /// can replace the built-in search list rather than being stuck with a hardcoded array.</summary>
    [Fact]
    ...
    /// candidate for the other platform before reaching a name that can ever resolve.
    /// </summary>
    [Fact]
    ...
    /// mirror of the macOS assertion above.
    /// </summary>
    [Fact]
    ...
    /// platform-based reordering applied, preserving the override contract verified above.
    /// </summary>
    [Fact]
