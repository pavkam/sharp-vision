...
public sealed class EnvironmentSnapshotTests
{
    ...
    /// allowlist and every reader agree by construction rather than by review.</summary>
    [Fact]
    public void EnvironmentNames_WhenRead_MatchDocumentedVariableNames()
    {
        ...
        EvidenceEnvironmentVars.NoColor.ShouldBe("NO_COLOR");
    ...
    /// recognized and canonicalized, the same way the other recognized keys are.
    /// </summary>
    [Fact]
