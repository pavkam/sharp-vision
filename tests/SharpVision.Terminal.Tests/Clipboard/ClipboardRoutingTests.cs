...
/// <see cref="IProtocolSink"/> overloads (see #103), mirroring the existing Kitty graphics
/// routing test shape.
/// </summary>
public sealed class ClipboardRoutingTests
{
    ...
    /// unrelated in-flight transaction bound to a different ID (see #103 test obligations).
    /// </summary>
    [Fact]
