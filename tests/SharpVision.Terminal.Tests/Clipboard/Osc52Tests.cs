...
public sealed class Osc52Tests
{
    ...
    public void Write_WhenArgumentIsInvalid_ThrowsBeforeWriting()
    {
        ...
        _ = Should.Throw<ArgumentOutOfRangeException>(
            () => Osc52.Write(writer, Selection.Clipboard, [], maxBytes: 0));
        _ = Should.Throw<ArgumentException>(
            () => Osc52.Write(writer, Selection.Clipboard, "too long"u8, maxBytes: 2));
        _ = Should.Throw<ArgumentException>(
            () => Osc52.Write(writer, Selection.Clipboard, [0xff]));
