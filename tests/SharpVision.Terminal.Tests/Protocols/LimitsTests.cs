...
public sealed class LimitsTests
{
    ...
    {
        _ = Should.Throw<ArgumentOutOfRangeException>(static () => new Limits { MaxParameterBytes = 0 });
        _ = Should.Throw<ArgumentOutOfRangeException>(static () => new Limits { MaxIntermediateBytes = 0 });
        _ = Should.Throw<ArgumentOutOfRangeException>(static () => new Limits { MaxStringBytes = 0 });
        _ = Should.Throw<ArgumentOutOfRangeException>(static () => new Limits { MaxClipboardBytes = 0 });
        _ = Should.Throw<ArgumentOutOfRangeException>(static () => new Limits { MaxMetadataBytes = 0 });
        _ = Should.Throw<ArgumentOutOfRangeException>(static () => new Limits { MaxConcurrentQueries = 0 });
        _ = Should.Throw<ArgumentOutOfRangeException>(static () => new Limits { MaxCapabilityItems = 0 });
        _ = Should.Throw<ArgumentOutOfRangeException>(static () => new Limits { MaxCapabilityValueBytes = 0 });
        _ = Should.Throw<ArgumentOutOfRangeException>(static () => new Limits { QueryTimeout = TimeSpan.Zero });
        _ = Should.Throw<ArgumentOutOfRangeException>(static () =>
            new Limits { QueryTimeout = Timeout.InfiniteTimeSpan });
    }
