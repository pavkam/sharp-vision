...
public sealed class Gallery: Screen
{
    ...
    [
        ...
        ("Dialogs", OpenFilePickerPane.Title, static () => new OpenFilePickerPane()),
        ("Dialogs", SaveFilePickerPane.Title, static () => new SaveFilePickerPane()),
        ...
        ("Notifications", InfoBarPane.Title, static () => new InfoBarPane()),
