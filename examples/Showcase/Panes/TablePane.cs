...
internal sealed class TablePane: CompositeControl
{
    ...
    private static DocPage CreateContent()
    {
        ...
        var dynamic = new Table { Width = Length.Cells(42), CellPadding = new Thickness(1, 0) };
        ...
        var unicode = new Table { Width = Length.Cells(44), CellPadding = new Thickness(1, 0), ShowGridLines = true };
