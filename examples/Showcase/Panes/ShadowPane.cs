        ...
        return new DocPage(
            ...
            new DocSection(
                ...
                new DocExample(
                    ...
                    "control.Shadow = new Shadow(true, ShadowMode.FractionalBlock, new Point(1, 1), new Rune('▓'), ThemeColor.ControlShadow, Color.Transparent, ThemeDecoration.Shadow);")),
            new DocSection(
                "🧭",
                "Signed placement",
                ...
                new DocExample(
                    ...
                    "control.Shadow = new Shadow(true, ShadowMode.Composite, new Point(-2, -1), new Rune('▓'), ThemeColor.ControlShadow, Color.Transparent, ThemeDecoration.Shadow);")),
            new DocSection(
                "🎛️",
                "Enablement and zero offset",
                "<info>Shadow.IsVisible</info> is independent of its other values. A visible shadow at (0,0) deliberately has no detached footprint.",
                new DocExample(
                    "Live enable switch",
