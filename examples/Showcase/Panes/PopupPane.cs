...
internal sealed class PopupPane: CompositeControlBase
{
    ...
    private static DocPage CreateContent()
    {
        ...
        var placementSeparator = new Separator { Width = Length.Cells(42) };
        ShowcasePaneHelpers.Place(above, 15, 3);
        ShowcasePaneHelpers.Place(left, 2, 9);
        ShowcasePaneHelpers.Place(placementAnchor, 15, 9);
        ShowcasePaneHelpers.Place(right, 30, 9);
        ShowcasePaneHelpers.Place(below, 15, 16);
