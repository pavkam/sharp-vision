...
internal sealed class DataBindingPane: CompositeControlBase
{
    ...
    internal DataBindingPane()
    {
        ...
        _ = enabled.Bind(Model, source => source.IsEnabled);
        ...
        InitializeContent(new DocPage(
            ...
            new DocSection(
                ...
                new DocExample(
                    ...
                    new DocColumn(
                        new DocRow(ShowcasePaneHelpers.DimCaption("Status text", Length.Cells(14)), oneWayText),
                        new DocRow(ShowcasePaneHelpers.DimCaption("RadioButton", Length.Cells(14)), primary),
                        new DocRow(ShowcasePaneHelpers.DimCaption("Slider", Length.Cells(14)), slider),
                        new DocRow(ShowcasePaneHelpers.DimCaption("ScrollBar", Length.Cells(14)), scrollBar),
                        new DocRow(ShowcasePaneHelpers.DimCaption("ProgressBar", Length.Cells(14)), progress),
                        new DocRow(ShowcasePaneHelpers.DimCaption("ColorPicker", Length.Cells(14)), color)))),
            new DocSection(
                "📚",
