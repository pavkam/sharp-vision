...
internal sealed class ButtonPane: CompositeControlBase
{
    ...
    private static DocPage CreateContent()
    {
        ...
        // Shadow variants share activation semantics but differ in elevation rendering.
        ...
        var shadowPatternLine = string.Concat(Enumerable.Repeat("   ·", 17));
