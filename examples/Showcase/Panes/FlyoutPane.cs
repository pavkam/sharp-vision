...
internal sealed class FlyoutPane: CompositeControlBase
{
    ...
    private static DocPage CreateContent()
    {
        ...
        ShowcasePaneHelpers.Place(aboveBtn, 15, 3);
        ShowcasePaneHelpers.Place(leftBtn, 2, 8);
        ShowcasePaneHelpers.Place(placementAnchor, 15, 8);
        ShowcasePaneHelpers.Place(rightBtn, 30, 8);
        ShowcasePaneHelpers.Place(belowBtn, 15, 13);
