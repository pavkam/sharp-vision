...
internal sealed class DockPane: CompositeControl
{
    ...
    private static DocPage CreateContent()
    {
        ...
        Dock order = new() { Width = Length.Cells(42), Height = Length.Cells(7), LastChildFills = true };
        ...
        var remaining = new Dock { Width = Length.Cells(48), Height = Length.Cells(5), Spacing = 1 };
