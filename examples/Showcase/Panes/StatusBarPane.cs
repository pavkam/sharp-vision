        ...
        return new DocPage(
            ...
            new DocSection(
                ...
                new DocExample(
                    ...
                    "Move the pointer across the editor to update <info>Mouse</info> coordinates. The leading Spinner and retained <info>CheckBox</info> share the same uninterrupted Bar background as passive status text; mixed Unicode separators divide trailing context, disabled <info>RO</info> changes only its ink, and the CheckBox toggles autosave through ordinary input.",
                    workspace,
