        ...
        return new DocPage(
            ...
            new DocSection(
                ...
                new DocExample(
                    ...
                    "Move the pointer across the editor to update its compact coordinates. Click <info>Auto</info>, or Tab to it and press <reverse>Space</reverse>, to toggle autosave. The Spinner and retained <info>CheckBox</info> share the same uninterrupted Bar background as passive status text; mixed Unicode separators divide trailing context, and disabled <info>RO</info> changes only its ink.",
                    workspace,
                    "var status = new StatusBar();\nstatus.Items.Add(new StatusBarItem\n{\n    Content = new Stack\n    {\n        Orientation = Orientation.Horizontal,\n        Children = { new Spinner(), new Text(\"Index\") }\n    }\n});\nstatus.Items.Add(new StatusBarItem\n{\n    Alignment = StatusBarItemAlignment.Right,\n    Content = new CheckBox { Text = \"Auto\" }\n});\nstatus.Items.Add(new StatusBarItem\n{\n    Alignment = StatusBarItemAlignment.Right,\n    ShowLeftSeparator = true,\n    Content = pointerStatus\n});\nstatus.Items.Add(new StatusBarItem\n{\n    Alignment = StatusBarItemAlignment.Right,\n    IsEnabled = false,\n    Content = new Text(\"RO\")\n});\nDock.SetSide(status, DockSide.Bottom);")));
    }
}
