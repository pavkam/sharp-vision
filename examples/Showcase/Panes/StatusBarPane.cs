        ...
        return new DocPage(
            ...
            new DocSection(
                ...
                new DocExample(
                    ...
                    "Move the pointer across the editor to update <info>Mouse</info> coordinates. The leading Spinner advances independently; mixed Unicode separators divide trailing context, the disabled <info>RO</info> item changes ink without breaking the Bar fill, and the retained <info>CheckBox</info> toggles autosave status through ordinary input.",
                    workspace,
