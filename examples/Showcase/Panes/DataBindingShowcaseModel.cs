...
internal sealed class DataBindingShowcaseModel: INotifyPropertyChanged
{
    ...
    public string? OneWayText
    {
        ...
        set
        {
            ...
            field = value;
            PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(OneWayText)));
        }
    }
    ...
    public string? TwoWayText
    {
        ...
        set
        {
            ...
            field = value;
            PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(TwoWayText)));
        }
    }
    ...
    public string? OneWayToSourceText
    {
        ...
        set
        {
            ...
            field = value;
            PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(OneWayToSourceText)));
        }
    }
    ...
    public object? CommandParameter
    {
        ...
        set
        {
            ...
            field = value;
            PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(CommandParameter)));
        }
    }
