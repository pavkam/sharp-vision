...
internal sealed class MenuItemPane: CompositeControlBase
{
    ...
    private static DocPage CreateContent()
    {
        ...
        var deployItem = new MenuItem { Text = "&Deploy", Enabled = false };
        ...
        // The frame's own fixed width reserves screen columns to the right of the roster so a
        // captured "More options" submenu renders inside this bordered surface instead of the
        // Dock's default fill stretching the roster to swallow that space.
            ...
            new DocSection(
                ...
                new DocExample(
                    ...
                    "menu.Items.Add(new MenuItem { Text = \"&New\" });\n" +
                        ...
                        "menu.Items.Add(new MenuItem { Text = \"&Deploy\", Enabled = false });")));
    }
