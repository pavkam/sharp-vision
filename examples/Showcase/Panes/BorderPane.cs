        ...
        return new DocPage(
            ...
            new DocSection(
                ...
                new DocExample(
                    ...
                    "Themes change colors, never glyph geometry. ASCII remains the portable fallback; block and shade families are deliberately decorative.",
                    families,
                    "control.Border = new Border(BorderSide.All, BorderGlyphStyle.Rounded, ThemeColor.ControlBorder, Color.Transparent, ThemeDecoration.Border);")),
            new DocSection(
                "📏",
                "Independent edges",
                ...
                new DocExample(
                    ...
                    edges,
                    "control.Border = new Border(BorderSide.Left | BorderSide.Bottom, BorderGlyphStyle.Light, ThemeColor.ControlBorder, Color.Transparent, ThemeDecoration.Border);")),
            new DocSection(
                "🎨",
                "Border appearance",
