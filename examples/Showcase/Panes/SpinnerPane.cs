...
internal sealed class SpinnerPane: CompositeControlBase
{
    ...
    private static DocPage CreateContent()
    {
        ...
        var paused = new Spinner { Style = SpinnerStyle.DenseBraille, Playing = false };
        return new DocPage(
            Title,
            ...
            new DocSection(
                "⏱️",
                "Playback",
                "<info>Interval</info> changes cadence, while <info>Playing</info> pauses and resumes without discarding the current frame.",
                new DocExample(
                    "Fast and paused",
                    ...
                    "var paused = new Spinner { Playing = false };")));
    }
}
